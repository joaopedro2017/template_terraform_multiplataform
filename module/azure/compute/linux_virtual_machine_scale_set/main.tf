module "resource_group" {
  ...
  resource_group_name = "tf-vmss-linux-${var.vmss_name}"
  location            = var.location
  tags = {
    VMSSLinux = var.vmss_name
    Regiao    = var.location
  }
}
...
module "virtual_network" {
  ...
  virtual_network_name = "VMSS-Linux-Terraform-VNet"
...
module "subnet" {
  ...
  subnet_name          = "VMSS-Linux-Terraform-Subnet"
